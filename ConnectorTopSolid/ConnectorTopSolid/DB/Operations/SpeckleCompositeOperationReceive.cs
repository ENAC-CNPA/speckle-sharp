...
{
    public sealed class SpeckleCompositeOperationReceive : SpeckleCompositeOperation
    {
        ...
        public SpeckleCompositeOperationReceive(ref TopSolid.Kernel.DB.Documents.Document inDocument, int inId)
            : base(ref inDocument, inId)
        {
