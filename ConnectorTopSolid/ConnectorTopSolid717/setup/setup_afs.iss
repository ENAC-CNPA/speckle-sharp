...
#define Guid "{2F1A902F-2B97-4127-A2FA-2A4945CD8F36}"
#define SrcFolder "D:\Sources\Topsolid 7.17\Release x64"
#define SpeckleSrcFolder "D:\Sources\Topsolid 7.17\Release x64\Speckle"
...
#define KeyFileName "D:\Sources\Workspaces\TopSolid\TopSolid v7.17\Work\Deployment\Generator\Keys\TOPSOLIDSASVerisignKey-16-10-2025.pfx"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
SignTool=signtool sign /a /d {#AppName} /du https://www.topsolid.com /i Digicert /f $q{#KeyFileName}$q /p 4z6hFop47Qh3zF /fd sha1 /t http://timestamp.digicert.com $f
SignTool=signtool sign /a /d {#AppName} /du https://www.topsolid.com /i Digicert /f $q{#KeyFileName}$q /p 4z6hFop47Qh3zF /fd sha256 /tr http://sha256timestamp.ws.symantec.com/sha256/timestamp /td sha256 /as $f
AppId={{#Guid}
...
Source: "{#SpeckleSrcFolder}\Objects.Converter.TopSolid717.dll"; DestDir: "{userappdata}\Speckle\Kits\Objects"; Flags: ignoreversion;
Source: "{#SpeckleSrcFolder}\Objects.dll"; DestDir: "{userappdata}\Speckle\Kits\Objects"; Flags: ignoreversion onlyifdoesntexist;
...
Source: "{#SrcFolder}\Polly.Contrib.WaitAndRetry.dll"; DestDir: "{code:GetTopDir}\bin"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
Source: "{#SrcFolder}\Polly.dll"; DestDir: "{code:GetTopDir}\bin"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
Source: "{#SrcFolder}\Polly.Extensions.Http.dll"; DestDir: "{code:GetTopDir}\bin"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
...
Source: "{#SrcFolder}\System.DoubleNumerics.dll"; DestDir: "{code:GetTopDir}\bin"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
...
Source: "{#SrcFolder}\x86\libHarfBuzzSharp.dll"; DestDir: "{code:GetTopDir}\bin\x86"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
Source: "{#SrcFolder}\x86\libSkiaSharp.dll"; DestDir: "{code:GetTopDir}\bin\x86"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
...
Source: "{#SrcFolder}\SQLitePCLRaw.provider.dynamic_cdecl.dll"; DestDir: "{code:GetTopDir}\bin"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;

Source: "{#SrcFolder}\e_sqlite3.dll"; DestDir: "{code:GetTopDir}\bin"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
Source: "{#SrcFolder}\runtimes\win-x64\native\e_sqlite3.dll"; DestDir: "{code:GetTopDir}\bin\runtimes\win-x64\native"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
...
Source: "{#SrcFolder}\Sentry.Serilog.dll"; DestDir: "{code:GetTopDir}\bin"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
Source: "{#SrcFolder}\Serilog.dll"; DestDir: "{code:GetTopDir}\bin"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
Source: "{#SrcFolder}\Serilog.Enrichers.ClientInfo.dll"; DestDir: "{code:GetTopDir}\bin"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
Source: "{#SrcFolder}\Serilog.Enrichers.GlobalLogContext.dll"; DestDir: "{code:GetTopDir}\bin"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
Source: "{#SrcFolder}\Serilog.Exceptions.dll"; DestDir: "{code:GetTopDir}\bin"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
Source: "{#SrcFolder}\Serilog.Formatting.Compact.dll"; DestDir: "{code:GetTopDir}\bin"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
Source: "{#SrcFolder}\Serilog.Sinks.Console.dll"; DestDir: "{code:GetTopDir}\bin"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
Source: "{#SrcFolder}\Serilog.Sinks.File.dll"; DestDir: "{code:GetTopDir}\bin"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
Source: "{#SrcFolder}\Serilog.Sinks.PeriodicBatching.dll"; DestDir: "{code:GetTopDir}\bin"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
Source: "{#SrcFolder}\Serilog.Sinks.Seq.dll"; DestDir: "{code:GetTopDir}\bin"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
Source: "{#SrcFolder}\SerilogTimings.dll"; DestDir: "{code:GetTopDir}\bin"; Flags: ignoreversion; Check: IsTopSolidDesignInstalled;
...
begin
  RegQueryStringValue(HKLM64, 'Software\{#AppPublisher}\TopSolid''Design\7.17', 'INSTALLDIR', TopDir);
